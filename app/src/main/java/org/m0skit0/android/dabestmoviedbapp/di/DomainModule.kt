...
val NAMED_SIMILAR_TV_SHOWS_USE_CASE = named("NAMED_SIMILAR_TV_SHOWS_USE_CASE")
...
val domainModule = module {
    ...
    single<SimilarTVShowsUseCase>(NAMED_SIMILAR_TV_SHOWS_USE_CASE) { { id -> similarTVShowsUseCase(id = id) } }
}
