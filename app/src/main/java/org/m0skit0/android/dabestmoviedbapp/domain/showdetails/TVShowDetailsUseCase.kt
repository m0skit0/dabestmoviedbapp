...
typealias TVShowDetailsUseCase = suspend (state: ShowDetailsState) -> Either<Throwable, ShowDetailsState>
...
): Either<Throwable, ShowDetailsState> = withUseCaseContext { repository(state) }
